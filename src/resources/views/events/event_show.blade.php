            ...
            <div class="col-md-10">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Описание базового пакета</td>
                            <td>{{ $event->event_basic_description }}</td>
                        </tr>
                        <tr>
                            <td>Описание VIP пакета</td>
                            <td>{{ $event->event_vip_description }}</td>
                        </tr>
                        <tr>
                            <td>Start</td>
                        ...
                        <tr>
                            <td>Participation packages</td>
                            <td>
                                <table class="table">
                                    <thead>
                                    <tr>
                                        <th scope="col">Название пакера</th>
                                        <th scope="col">Gender-ы</th>
                                        <th scope="col">Стоимость участия</th>
                                    </tr>
                                    </thead>
...
{{--                                @foreach($event->eventsstudents as $eventStudents)
                                    @foreach( as $package)
                                        {{ $package->id }}
                                        --}}{{--@foreach($package->genders as $gender)
                                        {{ $gender->name }} - {{ $eventStudents->eventParticipationPackage->cost }}<br>
                                        @endforeach--}}{{--
                                    @endforeach
                                @endforeach--}}
                            </td>
                        ...
                        <tr>
                            <td colspan="2"><img src="{{ asset('storage/images/events/' . $event->photo) }}" alt="" width="500"></td>
                        </tr>
