                                ...
                                <table class="table">
                                    ...
                                    @foreach($event->students as $student)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('storage/images/' . $student->profile_image) }}" alt="" width="100"></td>
                                            <td>
                                                <strong>{{ $student->pivot->moderation}}</strong><br>
                                                <input type="radio"
                                                       name="moderation_yes"
                                                       id="moderation_yes"
                                                       value="1"
                                                {{ $student->pivot->moderation == '1' ? 'checked' : '' }}>
                                                <label for="moderation_yes">Yes</label><br>
                                                <input type="radio"
                                                       name="moderation_no"
                                                       id="moderation_no"
                                                       value="0"
                                                {{ $student->pivot->moderation == '0' ? 'checked' : '' }}>
                                                <label for="moderation_no">No</label><br>
                                                <input type="radio"
                                                       name="moderation"
                                                       id="moderation"
                                                       value="2"
                                                {{ $student->pivot->moderation == '2' ? 'checked' : '' }}>
                                                <label for="moderation">Moderate</label>
                                            ...
                                            <td>{{ $student->pivot->event_participation_package_id }}</td>
                                            <td></td>
                                            <td class="links-block">
                                                <a href="{{ route('event_member_delete', ['id' => $student->id]) }}" class="btn btn-danger">Удалить</a>
                                            </td>
